...
import img2 from "../../assets/comados/c1.jpg";
import img3 from "../../assets/comados/c1.jpg";
      ...
      {noticiaDestaque && (
        <div className="fixed top-0 left-0 w-screen h-screen bg-preta flex items-center justify-center z-100">
          ...
          ">
            ...
            <div className="h-10 m-2 flex flex-col   items-center justify-center  ">

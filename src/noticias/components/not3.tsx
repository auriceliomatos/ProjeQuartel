...
const img1 = "https://i.im.ge/2025/07/31/JPPVeh.e-3.jpeg";
// importações de imagens secundarias
const img2 = "https://i.im.ge/2025/07/31/JPPKc8.e-2.jpeg";
const img3 = "https://i.im.ge/2025/07/31/JPPkDM.e-1.jpeg";

import React, { useState } from "react";

export const Noticia03 = () => {
  ...
  const noticias = [
    {
      ...
      imagem: img1,
      descricao: `
            Ao chegar ao local, a guarnição: Realizou o reconhecimento do local, constatando que o cacimbão possuía cerca de 5 metros de profundidade, com água turva e sem visibilidade; Tentou, sem sucesso, efetuar a captura dos animais aquáticos, devido à falta de visibilidade e à natureza do terreno; Diante da inviabilidade de remoção no momento, a guarnição orientou o solicitante e moradores locais a aguardar o esvaziamento natural do poço ou providenciar bomba para retirada da água, o que possibilitará ações futuras com maior segurança e eficácia.
